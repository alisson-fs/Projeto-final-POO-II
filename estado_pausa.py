...
class EstadoPausa(Estado):
    def __init__(self, pontuacao):
        ...
        self.__texto_continuar = Texto("Continuar", "Materials/Retro Gaming.ttf", 40, self.WHITE, self.tela, [75, 210])
        ...
        self.__texto_menu = Texto("Menu", "Materials/Retro Gaming.ttf", 40, self.WHITE, self.tela, [135, 310])
        ...
        self.__texto_som = Texto("Som", "Materials/Retro Gaming.ttf", 40, self.WHITE, self.tela, [150, 410])
        self.__fundo_som = Fundo([20, 400, 360, 70], self.WHITE, self.tela)
